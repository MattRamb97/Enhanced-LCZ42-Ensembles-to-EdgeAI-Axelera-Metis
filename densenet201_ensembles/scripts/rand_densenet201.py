...
def train_rand_densenet201(cfgT: Dict) -> Dict:
    """
    Python counterpart of MATLAB Rand_DenseNet201.
    ...
    print(f"[INFO] Training {num_members} ensemble members (RAND / DenseNet201).")

    for member_idx in range(num_members):
        print(f"\n[RAND] Member {member_idx + 1:02d}/{num_members}")
