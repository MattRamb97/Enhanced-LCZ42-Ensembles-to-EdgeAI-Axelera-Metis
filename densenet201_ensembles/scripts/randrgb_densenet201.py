...
def train_randrgb_densenet201(cfgT: Dict) -> Dict:
    """
    Python counterpart of MATLAB RandRGB_DenseNet201.
    ...
    print(f"[INFO] Training {num_members} ensemble members (RANDRGB / DenseNet201).")
