...
SR_DATASETS = {
    "bsrnet2x":  "testing_bsrnet2x.h5",
    "edsr4x":     "testing_edsr4x.h5",
    "realesrgan4x": "testing_realesrgan4x.h5",
    "vdsr2x":     "testing_vdsr2x.h5",
    "edsr2x":     "testing_edsr2x.h5",
    "esrgan2x":   "testing_esrgan2x.h5",
    "swinir2x":   "testing_swinir2x.h5",
    "vdsr3x":     "testing_vdsr3x.h5",
}
...
if __name__ == "__main__":
    for tag, filename in SR_DATASETS.items():
        ...
        output_ms_file = OUTPUT_DIR / f"tda_MS_features_test_{tag}.h5"
        ...
        with h5py.File(h5_path, "r") as f:
            ...
            if tda_ms is not None:
                with h5py.File(output_ms_file, "w") as out_f:
                    out_f.create_dataset(f"tda_MS_features_test_{tag}", data=tda_ms)
