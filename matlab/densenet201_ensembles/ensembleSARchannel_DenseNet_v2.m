% ENSEMBLESARCHANNEL_DENSENET_V2
...
%   maxEpochs      (default: 12)    % Number of training epochs
%   miniBatchSize  (default: 128)   % Mini-batch size
...
function res = ensembleSARchannel_DenseNet_v2(cfgT)
    ...
    % ---------- base network ----------
    matfile = fullfile('matlab', 'densenet201_pretrained.mat');
